      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <div className="flex gap-2 max-w-md mx-auto">
            ...
            />
            <button className="h-12 px-6 rounded-xl bg-background text-foreground font-semibold hover:bg-background/90 transition-colors shadow-lg flex items-center gap-2 text-sm shrink-0">

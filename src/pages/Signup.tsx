      ...
      <div className="flex-1 flex items-center justify-center px-4 py-16">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Start shopping in just a few steps</p>
          </div>

          {/* Social */}
          <div className="flex gap-3 mb-6">
            <Button variant="outline" className="flex-1 h-12 gap-2 text-sm font-medium">
                  ...
                  {passwordChecks.map((check) => {
                    ...
                    return (
                      <div key={check.label} className="flex items-center gap-2 text-xs">
                        <Check className={`h-3.5 w-3.5 ${pass ? "text-[hsl(var(--success))]" : "text-muted-foreground/40"}`} />
